...
function UI.SetDebug(self, maybeVal)
  ...
  if UI.Debug then
    warn("[NovaPremiumUI][debug] Debug enabled")
  end
end
...
UI.DefaultTheme = {
  ...
  Colors = {
    BgA = Color3.fromRGB(7, 8, 11),
    BgB = Color3.fromRGB(10, 12, 16),
    Surface = Color3.fromRGB(14, 16, 21),
    SurfaceGlass = Color3.fromRGB(16, 19, 25),
    ExpandableSurface = Color3.fromRGB(18, 21, 28),
    ExpandableSurfaceOpen = Color3.fromRGB(23, 27, 35),
    ExpandableTitle = Color3.fromRGB(16, 19, 25),
    ExpandableTitleOpen = Color3.fromRGB(29, 22, 28),
    NestedSurface = Color3.fromRGB(11, 13, 18),
    NestedSurface2 = Color3.fromRGB(17, 20, 26),
    NestedStroke = Color3.fromRGB(39, 45, 56),
    Surface2 = Color3.fromRGB(19, 22, 29),
    Surface3 = Color3.fromRGB(26, 31, 39),
    Sidebar = Color3.fromRGB(10, 12, 16),
    Sidebar2 = Color3.fromRGB(13, 16, 21),
    Stroke = Color3.fromRGB(46, 53, 65),
    StrokeSoft = Color3.fromRGB(31, 37, 47),
    Text = Color3.fromRGB(235, 237, 241),
    TextDim = Color3.fromRGB(154, 162, 173),
    TextMuted = Color3.fromRGB(92, 101, 115),
    Accent = Color3.fromRGB(214, 72, 78),
    Accent2 = Color3.fromRGB(237, 104, 108),
    Accent3 = Color3.fromRGB(164, 72, 88),
    AccentSoft = Color3.fromRGB(43, 24, 31),
    Input = Color3.fromRGB(11, 13, 18),
    Hover = Color3.fromRGB(25, 29, 37),
    Active = Color3.fromRGB(45, 25, 32),
...
local function attachSmoothScroll(scroller, theme, trackConnection)
  ...
  pcall(function()
    scroller:SetAttribute("NovaSmoothScroll", true)
  end)
  pcall(function()
    scroller.ScrollBarImageColor3 = theme.Colors.Accent3 or theme.Colors.Accent
  end)
  pcall(function()
    scroller.ScrollBarImageTransparency = 0.45
  end)
  pcall(function()
...
local function applyImageRect(img, rectOffset, rectSize)
...
local function createNovaMark(parent, theme, size, imageSource, rectOffset, rectSize, imageScale)
  ...
  corner(badge, hasImage and math.max(8, math.floor(size * 0.18)) or math.max(10, math.floor(size * 0.28)))
  stroke(badge, theme.Colors.StrokeSoft or theme.Colors.Stroke, 1, hasImage and 0.2 or 0.22)
  if hasImage then
    gradient(badge, theme.Colors.Input, theme.Colors.Surface2 or theme.Colors.Input, 20)
  else
    gradient(badge, theme.Colors.AccentSoft, theme.Colors.Input, 38)
  end

  if imageSource then
    local scale = math.clamp(tonumber(imageScale) or 1, 0.72, 1.18)
    ...
    applyImageRect(img, rectOffset, rectSize)
  else
...
local function ensureNotifLayer(_theme)
...
function UI:CreateWindow(opts)
  ...
  if not parented or not gui.Parent then
    ...
    task.spawn(function()
      ...
      if not okRetry then
        if UI.Debug then
          warn("[NovaPremiumUI][debug] ScreenGui retry parent failed")
        end
    ...
    if UI.Debug then
      warn("[NovaPremiumUI][debug] ScreenGui parent set to", gui.Parent:GetFullName())
    end
  end
  ...
  local topFill = make("Frame", {
    ...
    BackgroundColor3 = theme.Colors.Sidebar2 or theme.Colors.Sidebar,
    BorderSizePixel = 0,
    Parent = top,
  })
  ...
  make("TextLabel", {
    ...
    TextXAlignment = Enum.TextXAlignment.Left,
    TextColor3 = theme.Colors.TextDim,
    Text = tostring(opts.Subtitle or opts.LoadingSubtitle or "Rivals Kontrollzentrum"),
    Parent = top,
  })
  ...
  closeBtn.MouseEnter:Connect(function()
    tween(closeBtn, theme.Anim.Fast, { BackgroundColor3 = theme.Colors.AccentSoft or theme.Colors.Surface2 })
  end)
  closeBtn.MouseLeave:Connect(function()
    tween(closeBtn, theme.Anim.Fast, { BackgroundColor3 = theme.Colors.Surface3 or theme.Colors.Surface2 })
  end)
  ...
  settingsBtn.MouseEnter:Connect(function()
    tween(settingsBtn, theme.Anim.Fast, { BackgroundColor3 = theme.Colors.Hover or theme.Colors.Surface2 })
  end)
  settingsBtn.MouseLeave:Connect(function()
    tween(settingsBtn, theme.Anim.Fast, { BackgroundColor3 = theme.Colors.Input })
  end)
  ...
  local extraSettingsHeight = 0
  local function settingInput(label, placeholder, value, onSubmit, order)
    make("TextLabel", {
      BackgroundTransparency = 1,
      Size = UDim2.new(1, 0, 0, 15),
      Font = theme.Font,
    ...
    corner(box, theme.Radius - 5)
    stroke(box, theme.Colors.StrokeSoft or theme.Colors.Stroke, 1, 0.42)

    bindConnection(box.FocusLost:Connect(function()
      safeCallback(onSubmit, box.Text, box)
    end))
    extraSettingsHeight = extraSettingsHeight + 55
    return box
  end
  ...
  settingRow("accent", "Accent", {
    ...
    },
    {
      Label = "Steel",
      Colors = {
        Accent = Color3.fromRGB(126, 134, 146),
        Accent2 = Color3.fromRGB(158, 166, 178),
        Accent3 = Color3.fromRGB(118, 127, 140),
        AccentSoft = Color3.fromRGB(35, 39, 47),
        Stroke = Color3.fromRGB(58, 65, 77),
        Active = Color3.fromRGB(40, 45, 54),
        Hover = Color3.fromRGB(29, 33, 40),
      },
    },
    {
      Label = "Signal",
      Colors = {
        Accent = Color3.fromRGB(79, 152, 140),
        Accent2 = Color3.fromRGB(109, 190, 174),
        Accent3 = Color3.fromRGB(73, 128, 124),
        AccentSoft = Color3.fromRGB(24, 43, 42),
        Stroke = Color3.fromRGB(48, 68, 69),
        Active = Color3.fromRGB(28, 49, 48),
        Hover = Color3.fromRGB(25, 35, 38),
      },
    },
  }, function(option)
  ...
  settingRow("background", "Background", {
    ...
    },
    {
      Label = "Carbon",
      Colors = {
        BgA = Color3.fromRGB(7, 8, 10),
        BgB = Color3.fromRGB(12, 13, 16),
        Surface = Color3.fromRGB(16, 18, 22),
        SurfaceGlass = Color3.fromRGB(18, 21, 26),
        Surface2 = Color3.fromRGB(20, 24, 30),
        Surface3 = Color3.fromRGB(27, 32, 40),
        Sidebar = Color3.fromRGB(12, 14, 18),
        Sidebar2 = Color3.fromRGB(16, 19, 24),
        Input = Color3.fromRGB(11, 13, 17),
        ExpandableSurface = Color3.fromRGB(21, 25, 32),
        ExpandableSurfaceOpen = Color3.fromRGB(26, 32, 41),
        ExpandableTitle = Color3.fromRGB(18, 22, 28),
        ExpandableTitleOpen = Color3.fromRGB(29, 37, 48),
        NestedSurface = Color3.fromRGB(10, 12, 16),
        NestedSurface2 = Color3.fromRGB(17, 20, 26),
        StrokeSoft = Color3.fromRGB(36, 42, 52),
        NestedStroke = Color3.fromRGB(39, 45, 55),
      },
    },
    {
      Label = "Neutral",
      Colors = {
        BgA = Color3.fromRGB(12, 12, 13),
        BgB = Color3.fromRGB(17, 18, 20),
        Surface = Color3.fromRGB(22, 23, 26),
        SurfaceGlass = Color3.fromRGB(24, 26, 30),
        Surface2 = Color3.fromRGB(28, 30, 34),
        Surface3 = Color3.fromRGB(36, 39, 45),
        Sidebar = Color3.fromRGB(16, 17, 20),
        Sidebar2 = Color3.fromRGB(21, 23, 27),
        Input = Color3.fromRGB(16, 17, 20),
        ExpandableSurface = Color3.fromRGB(28, 31, 36),
        ExpandableSurfaceOpen = Color3.fromRGB(36, 41, 48),
        ExpandableTitle = Color3.fromRGB(24, 27, 32),
        ExpandableTitleOpen = Color3.fromRGB(39, 45, 53),
        NestedSurface = Color3.fromRGB(15, 16, 19),
        NestedSurface2 = Color3.fromRGB(24, 26, 30),
        StrokeSoft = Color3.fromRGB(45, 50, 58),
        NestedStroke = Color3.fromRGB(48, 54, 63),
      },
    },
  }, function(option)
    window:ApplyThemePatch({ Colors = option.Colors })
  ...
  settingRow("glow", "Glow", {
    { Label = "Low", BlurSize = 0, ShadowTransparency = 0.9 },
    { Label = "Mid", BlurSize = 2, ShadowTransparency = 0.84 },
    { Label = "High", BlurSize = 4, ShadowTransparency = 0.78 },
  }, function(option)
  ...
  if type(opts.SettingsInputs) == "table" then
    window._settingsInputs = window._settingsInputs or {}
    for index, inputCfg in ipairs(opts.SettingsInputs) do
      local inputBox = settingInput(
        inputCfg.Label or inputCfg.Name or inputCfg.Key or ("Input " .. tostring(index)),
        inputCfg.Placeholder or "",
        inputCfg.Value or inputCfg.CurrentValue or "",
        inputCfg.Callback,
        50 + ((index - 1) * 10)
      )
      if inputCfg.Key then
        window._settingsInputs[tostring(inputCfg.Key)] = inputBox
      end
    end
  end

  local settingsOpen = false
  local settingsHeight = 292 + extraSettingsHeight
  ...
  function window:SetSettingsInput(key, value)
    local inputBox = self._settingsInputs and self._settingsInputs[tostring(key or "")]
  ...
  function window:_Switch(tab)
    ...
    if prev and prev.Page and prev.Page.Visible then
      ...
      task.delay(theme.Anim.Normal, function()
        if prev.Page then
  ...
  function window:Confirm(opts)
    ...
    cancelBtn.MouseEnter:Connect(function()
      tween(cancelBtn, theme.Anim.Fast, { BackgroundColor3 = theme.Colors.Surface })
    end)
    cancelBtn.MouseLeave:Connect(function()
      tween(cancelBtn, theme.Anim.Fast, { BackgroundColor3 = theme.Colors.Input })
    end)
    confirmBtn.MouseEnter:Connect(function()
      tween(confirmBtn, theme.Anim.Fast, { BackgroundColor3 = theme.Colors.Accent2 or theme.Colors.Accent })
    end)
    confirmBtn.MouseLeave:Connect(function()
      tween(confirmBtn, theme.Anim.Fast, { BackgroundColor3 = theme.Colors.Accent })
    end)
  ...
  function window:CreateTab(name)
    ...
    function tab:CreateSection(s)
      local f =
        make("Frame", { Size = UDim2.new(1, 0, 0, 26), BackgroundColor3 = theme.Colors.Input, BackgroundTransparency = 0.72, BorderSizePixel = 0, Parent = p })
      ...
      make("TextLabel", {
        ...
        Font = Enum.Font.GothamBold,
        TextSize = 11,
        TextColor3 = theme.Colors.TextMuted or theme.Colors.TextDim,
        TextXAlignment = Enum.TextXAlignment.Left,
        Text = string.upper(tostring(s or "Section")),
        Parent = f,
      })
      return reg({
        Frame = f,
        _token = string.lower(tostring(s or "")),
    ...
    function tab:CreateButton(cfg)
      ...
      btn.MouseEnter:Connect(function()
        tween(scale, theme.Anim.Fast, { Scale = 1.015 }, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
      end)
    ...
    function tab:CreateToggle(cfg)
      ...
      local hit = make(
        "TextButton",
        { BackgroundTransparency = 1, Size = UDim2.new(1, -72, 1, 0), Position = UDim2.new(0, 0, 0, 0), AutoButtonColor = false, Text = "", Parent = row }
      )
      ...
      local k = make(
        "Frame",
        { Size = UDim2.new(0, 22, 0, 22), Position = UDim2.new(0, 3, 0.5, -11), BackgroundColor3 = Color3.new(1, 1, 1), BorderSizePixel = 0, Parent = sw }
      )
      corner(k, 999)
      ...
      local function render(anim)
        ...
        if anim then
          ...
          tween(swStroke, theme.Anim.Fast, {
            Color = state and (theme.Colors.Accent2 or theme.Colors.Accent) or (theme.Colors.StrokeSoft or theme.Colors.Stroke),
            Transparency = state and 0.08 or 0.34,
          })
      ...
      local function setHover(active)
        tween(glow, theme.Anim.Fast, { BackgroundTransparency = active and 0.84 or 0.94 })
      end
    ...
    function tab:CreateExpandableToggle(cfg)
      ...
      local function render()
        ...
        local baseSurface = expanded and (theme.Colors.ExpandableSurfaceOpen or theme.Colors.ExpandableSurface or theme.Colors.Surface2)
          or (theme.Colors.ExpandableSurface or theme.Colors.SurfaceGlass or theme.Colors.Surface)
        local titleSurface = expanded and (theme.Colors.ExpandableTitleOpen or theme.Colors.Active or theme.Colors.Surface3)
        ...
        tween(toggleStroke, theme.Anim.Fast, {
          Color = enabled and (theme.Colors.Accent2 or theme.Colors.Accent) or (theme.Colors.StrokeSoft or theme.Colors.Stroke),
          Transparency = enabled and 0.08 or 0.34,
        })
        tween(
          toggleKnob,
          theme.Anim.Fast,
          { Position = pos, BackgroundColor3 = enabled and Color3.new(1, 1, 1) or theme.Colors.TextDim },
      ...
      titleBtn.MouseEnter:Connect(function()
        tween(titleBtn, theme.Anim.Fast, { BackgroundColor3 = theme.Colors.Hover or theme.Colors.Surface2 })
      end)
      titleBtn.MouseLeave:Connect(function()
        tween(titleBtn, theme.Anim.Fast, {
          BackgroundColor3 = expanded and (theme.Colors.ExpandableTitleOpen or theme.Colors.Active or theme.Colors.Surface3)
            or (theme.Colors.ExpandableTitle or theme.Colors.Input),
        })
      end)
      ...
      function ctrl:CreateToggle(subCfg)
        return addChild(tab:CreateToggle(prefixed(subCfg)))
      end
      function ctrl:CreateSlider(subCfg)
        return addChild(tab:CreateSlider(prefixed(subCfg)))
      end
      ...
      function ctrl:CreateInput(subCfg)
        return addChild(tab:CreateInput(prefixed(subCfg)))
      end
      function ctrl:CreateButton(subCfg)
        return addChild(tab:CreateButton(prefixed(subCfg)))
      end
      function ctrl:CreateKeybind(subCfg)
        return addChild(tab:CreateKeybind(prefixed(subCfg)))
      end
      function ctrl:CreateLabel(subCfg)
        return addChild(tab:CreateLabel(subCfg))
      end
      function ctrl:CreateParagraph(subCfg)
        return addChild(tab:CreateParagraph(subCfg))
      end
    ...
    function tab:CreateSlider(cfg)
      ...
      corner(bar, 999)
      stroke(bar, theme.Colors.Stroke, 1, 0.45)
      local fill = make("Frame", { Size = UDim2.new(0, 0, 1, 0), BackgroundColor3 = theme.Colors.Accent, BorderSizePixel = 0, Parent = bar })
      corner(fill, 999)
      ...
      local function snap(v)
        return inc <= 0 and v or math.floor(v / inc + 0.5) * inc
      end
      ...
      bindConnection(UserInputService.InputChanged:Connect(function(i)
    ...
    function tab:CreatePlayerSearch(cfg)
      ...
      local placeholder = tostring(cfg.PlaceholderText or "Spieler suchen...")
    ...
    function tab:CreateOptionPicker(cfg)
      ...
      local alwaysOpen = true
      local showTitle = cfg.ShowTitle ~= false
      ...
      local rowHeight = math.clamp(tonumber(cfg.RowHeight) or 26, 22, 34)
      local gap = 6
      local collapsedHeight = 36
      local gridTop = showTitle and 34 or 8
      local bottomPad = 8
      local opened = true
      ...
      f.BackgroundTransparency = alwaysOpen and 0.02 or 0.04

      local title = make("TextButton", {
        BackgroundTransparency = 1,
        Size = UDim2.new(1, alwaysOpen and -20 or -130, 0, 26),
        Position = UDim2.new(0, 10, 0, 4),
        AutoButtonColor = false,
        Font = theme.Font,
        TextSize = 11,
      ...
      local function render()
        ...
        for _, btn in ipairs(buttons) do
          ...
          tween(btn, theme.Anim.Fast, {
            BackgroundColor3 = active and (theme.Colors.Active or theme.Colors.AccentSoft or theme.Colors.Surface3)
              or (theme.Colors.Input or theme.Colors.Surface),
            TextColor3 = active and theme.Colors.Text or theme.Colors.TextDim,
          ...
          if mark then
            tween(mark, theme.Anim.Fast, {
              ...
              Size = active and UDim2.new(0, 5, 0, 5) or UDim2.new(0, 0, 0, 0),
            })
          end
        end
      end
      local function setOpened(v, instant)
        opened = alwaysOpen or v == true
      ...
      local function rebuild()
        ...
        grid.Visible = opened
        grid.Position = UDim2.new(0, 10, 0, gridTop)
      ...
      return reg({
        ...
        SetOpened = function(_, v)
          setOpened(alwaysOpen or v, false)
        end,
        GetOpened = function()
          return opened
        end,
    ...
    function tab:CreateInput(cfg)
      ...
      local tb = make("TextBox", {
        ...
        TextColor3 = theme.Colors.Text,
        PlaceholderColor3 = theme.Colors.TextDim,
        PlaceholderText = tostring(cfg.PlaceholderText or "Eingeben..."),
        Text = tostring(cfg.CurrentValue or ""),
        ClearTextOnFocus = false,
        Parent = row,
      })
    ...
    function tab:CreateConfigList(cfg)
      ...
      make("TextLabel", {
        ...
        TextXAlignment = Enum.TextXAlignment.Left,
        TextTruncate = Enum.TextTruncate.AtEnd,
        Text = tostring(cfg.Name or "Gespeicherte Profile"),
        Parent = f,
      })
      ...
      make(
        "UIPadding",
        { PaddingLeft = UDim.new(0, 4), PaddingRight = UDim.new(0, 4), PaddingTop = UDim.new(0, 4), PaddingBottom = UDim.new(0, 4), Parent = listFrame }
      )
      ...
      local function render()
        ...
        for _, btn in ipairs(buttons) do
          ...
          tween(btn, theme.Anim.Fast, {
            BackgroundColor3 = active and (theme.Colors.Active or theme.Colors.AccentSoft or theme.Colors.Surface3)
              or (theme.Colors.SurfaceGlass or theme.Colors.Surface),
      ...
      return reg({
        Frame = f,
        _token = string.lower(string.format("%s %s", tostring(cfg.Name or "gespeicherte profile"), tostring(current))),
        SetVisible = function(_, v)
          f.Visible = v
        end,
        Set = function(self, v)
          setValue(v, false)
          self._token = string.lower(string.format("%s %s", tostring(cfg.Name or "gespeicherte profile"), tostring(current)))
        end,
        SetValue = function(self, v)
          setValue(v, false)
          self._token = string.lower(string.format("%s %s", tostring(cfg.Name or "gespeicherte profile"), tostring(current)))
    ...
    function tab:CreateKeybind(cfg)
      ...
      local function renderLabel()
        nameLabel.Text = listening and (name .. "  -  Taste druecken") or name
      ...
      local function normalizeKeyName(value)
        ...
        first = first:upper()
        if first ~= "" and Enum.KeyCode[first] then
          return first
        end
        return "None"
      end
      ...
      return reg({
        ...
        _token = string.lower(name),
        SetVisible = function(_, v)
          setCompactBindVisible(f, slot, v)
        end,
        Set = function(_, v)
          current = normalizeKeyName(v)
          pending = current
          listening = false
          renderLabel()
        end,
  ...
  local function setOpenPosition(pos)
    if slidDown or animatingToggle then
      return
    end
    openPos = pos
  ...
  function window:Destroy()
    ...
    if islandGui and islandGui.Parent then
      islandGui:Destroy()
    end
  end
  ...
  bindConnection(closeBtn.MouseButton1Click:Connect(function()
    window:Toggle()
  end))
  ...
  task.spawn(function()
    local okSplash = pcall(function()
      ...
      make("UIAspectRatioConstraint", { AspectRatio = 1, Parent = mark })
      ...
      if logoSource then
        splashLogo = make("ImageLabel", {
          BackgroundTransparency = 1,
          AnchorPoint = Vector2.new(0.5, 0.5),
          Size = UDim2.new(splashLogoScale, 0, splashLogoScale, 0),
          Position = UDim2.new(0.5, 0, 0.5, 0),
          Image = logoSource,
          ImageTransparency = 1,
          ScaleType = Enum.ScaleType.Fit,
        ...
        make("UIAspectRatioConstraint", { AspectRatio = 1, Parent = splashLogo })
        applyImageRect(splashLogo, splashLogoRectOffset, splashLogoRectSize)
      end
      ...
      local subText = make("TextLabel", {
        ...
        Font = theme.Font,
        TextSize = 13,
        Text = tostring(opts.LoadingSubtitle or opts.Subtitle or "Interface wird vorbereitet"),
        TextColor3 = theme.Colors.TextDim,
        TextTransparency = 1,
        ZIndex = 10002,
        Parent = splash,
      ...
      tween(
        flare,
        theme.Anim.Splash * 0.34,
        { Size = UDim2.new(0, 160, 0, 2), BackgroundTransparency = 0.58 },
        Enum.EasingStyle.Quart,
        Enum.EasingDirection.Out
      )
      ...
      if not fallbackLogo and not splashLogo and not splashRingLogo then
        tween(
          ...
          { TextTransparency = 0, Position = UDim2.new(0.2, -12, 0.5, -25) },
          Enum.EasingStyle.Quart,
          Enum.EasingDirection.Out
        )
        ...
        tween(
          codeRight,
          theme.Anim.Splash * 0.3,
          { TextTransparency = 0, Position = UDim2.new(0.8, -30, 0.5, -25) },
          Enum.EasingStyle.Quart,
          Enum.EasingDirection.Out
        )
      end
      ...
      for i, bar in ipairs(progressBars) do
        task.delay((i - 1) * 0.035, function()
          if bar and bar.Parent then
            tween(bar, theme.Anim.Fast, { BackgroundTransparency = i == 3 and 0.32 or 0.68 })
          end
        end)
      end
  ...
  if opts.ShowWelcome == true then
    window:Notify({ Title = tostring(opts.Title or "Nova Premium UI"), Content = "Bereit", Duration = 5 })
  end
